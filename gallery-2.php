...
<!-- Mirrored from miller.bslthemes.com/ashley-demo/project-1.phpgallery-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 May 2025 10:05:53 GMT -->
    ...
    <div class="mil-wrapper" id="top">
                            ...
                            <nav class="mil-main-menu" id="swupMenu">
                                <ul>
                                    <li class="mil-has-children mil-active">
                                        <a href="./index.phpgallery-1.php">Home</a>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="./team.phpgallery-1.php">Team</a>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="./gallery-1.php">Services</a>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="#.">Newsletter</a>
                                        <ul>
                                            <li><a href="blog.phpgallery-1.php">Blog List</a></li>
                                            <li><a href="publication.phpgallery-1.php">Publication</a></li>
                                        </ul>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="#.">Other pages</a>
                                        <ul>
                                            <li><a href="team.phpgallery-1.php">Team</a></li>
                                            <li><a href="contact.phpgallery-1.php">Contact</a></li>
                                            <li><a href="404.phpgallery-1.php">404</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 mil-mb-60">
                                            ...
                                            <ul class="mil-menu-list">
                                                <li><a href="project-1.phpgallery-1.php" class="mil-light-soft">Interior design
                                                        studio</a></li>
                                                <li><a href="project-2.phpgallery-1.php" class="mil-light-soft">Home Security
                                                        Camera</a></li>
                                                <li><a href="project-3.phpgallery-1.php" class="mil-light-soft">Kemia Honest
                                                        Skincare</a></li>
                                                <li><a href="project-4.phpgallery-1.php" class="mil-light-soft">Cascade of Lava</a>
                                                </li>
                                                <li><a href="project-5.phpgallery-1.php" class="mil-light-soft">Air Pro by
                                                        Molekule</a></li>
                                                <li><a href="project-6.phpgallery-1.php" class="mil-light-soft">Tony's
                                                        Chocolonely</a></li>
                                            </ul>
                            ...
                            <nav class="mil-main-menu" id="swupMenu">
                                <ul>
                                    <li class="mil-has-children">
                                        <a href="#.">Homepage</a>
                                        <ul>
                                            <li><a href="index.phpgallery-1.php">Landing page</a></li>
                                            <li><a href="home-2.phpgallery-1.php">Personal</a></li>
                                            <li><a href="portfolio-3.phpgallery-1.php">Portfolio slider</a></li>
                                        </ul>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="#.">Portfolio</a>
                                        <ul>
                                            <li><a href="portfolio-1.phpgallery-1.php">Grid type 1</a></li>
                                            <li><a href="portfolio-2.phpgallery-1.php">Grid type 2</a></li>
                                            <li><a href="portfolio-3.phpgallery-1.php">Slider</a></li>
                                        </ul>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="#.">Services</a>
                                        <ul>
                                            <li><a href="services.phpgallery-1.php">Services List</a></li>
                                            <li><a href="service.phpgallery-1.php">Single service</a></li>
                                        </ul>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="#.">Newsletter</a>
        ...
        <div class="mil-frame">
            <div class="mil-frame-top">
                <a href="index.phpgallery-1.php" class="mil-logo">A.</a>
                    ...
                    <div class="mil-banner-content mil-up">
                        ...
                        <div class="container">
                            <ul class="mil-breadcrumbs mil-mb-60">
                                <li><a href="index.phpgallery-1.php">Homepage</a></li>
                                <li><a href="portfolio-1.phpgallery-1.php">Portfolio</a></li>
                                <li><a href="project-1.phpgallery-1.php">Project</a></li>
                            </ul>
                ...
                <section class="mil-p-120-0">
                    <div class="container mil-p-0-120" id="project">
                        ...
                        <div class="mil-works-nav mil-up">
                            ...
                            <a href="gallery-3.php" class="mil-link mil-dark mil-arrow-place">
                ...
                <section class="mil-soft-bg">
                    <div class="container mil-p-120-120">
                        ...
                        <div class="mil-center">
                            ...
                            <div class="mil-up"><a href="contact.phpgallery-1.php" class="mil-button mil-arrow-place"><span>Contact
                                        us</span></a></div>
                        </div>
                    </div>
                </section>
...
<!-- Mirrored from miller.bslthemes.com/ashley-demo/project-1.phpgallery-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 May 2025 10:05:55 GMT -->
